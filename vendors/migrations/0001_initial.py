# Generated by Django 4.2.11 on 2024-05-09 04:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_code', models.CharField(default=uuid.uuid4, max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('po_number', models.CharField(default=vendors.models.generate_number, max_length=50, unique=True)),
